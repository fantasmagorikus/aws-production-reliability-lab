...
| Chose the Single-Region Identity Center configuration and proved the cost consequence rather than assuming it: zero customer managed KMS keys exist | `evidence/m0-preflight/02-account-security.txt` |
...
| Escolhi a configuracao Single-Region do Identity Center e provei a consequencia de custo em vez de presumi-la: existem zero chaves KMS gerenciadas pelo cliente | `evidence/m0-preflight/02-account-security.txt` |
